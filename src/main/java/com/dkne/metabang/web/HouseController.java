...
public class HouseController {
	...
	// show spec house info
	@ApiOperation(value = "조건 매물 정보 조회", notes = "성공시 조건에 맞는 매물의 정보를 반환합니다.")
	@PostMapping("/filter")
	public List<HouseResponseDto> showSpecHouse(@RequestBody HouseFilterRequestDto requestDto) {
		return houseService.findFilter(requestDto);
	}
